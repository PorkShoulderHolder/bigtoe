...
train_data_torch_bin_filename = rootdata..'/diagnosisFromLabs/data/train/train_lab_to_icd9_normalized'
valid_data_torch_bin_filename = rootdata..'/diagnosisFromLabs/data/valid/valid_lab_to_icd9_normalized.bin'
test_data_torch_bin_filename = rootdata..'/diagnosisFromLabs/data/test/test_lab_to_icd9_normalized'
